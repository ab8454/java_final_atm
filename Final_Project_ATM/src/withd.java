 ...
 * @author 안성호
 */
public class withd extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(withd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
